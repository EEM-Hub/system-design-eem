...
- **Q6**: WRONG — What is the purpose of tombstones in a distributed key-value store?
  - Expected: b
  - Got: {"type":"result","subtype":"success","is_error":false,"api_error_status":null,"duration_ms":4334,"du
...
- **Q10**: WRONG — In a Snowflake ID generator, what happens when the sequence number is exhausted within a single millisecond?
  - Expected: b
  - Got: {"type":"result","subtype":"success","is_error":false,"api_error_status":null,"duration_ms":3578,"du
...
- **Q14**: CORRECT — In double-entry bookkeeping, what invariant must every transaction maintain?
- **Q15**: CORRECT — What is the purpose of a write-ahead log (WAL)?
- **Q16**: CORRECT — What property makes HyperLogLog useful for counting distinct elements?
...
- **Q24**: CORRECT — In a stock exchange matching engine, what does price-time priority mean?
- **Q25**: CORRECT — What is the purpose of read repair in a distributed database?
- **Q26**: CORRECT — What does Yen's algorithm compute?
- **Q27**: CORRECT — What is the sliding window counter approach to rate limiting?
...
- **Tombstones and Deletion**: 0/1 (0%) **WEAK AREA**
- **Unique ID Generation**: 0/1 (0%) **WEAK AREA**
...
- **A* Search**: 1/1 (100%)
- **Double-Entry Bookkeeping**: 1/1 (100%)
